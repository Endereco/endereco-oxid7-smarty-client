...
[{if !$enderecoclient.bAllowControllerFilter || $enderecoclient.sControllerClass|in_array:$enderecoclient.aAllowedControllerClasses || ('order' == $enderecoclient.sControllerClass && $enderecoclient.sCHECKALL) }]
